...
import com.inso_world.binocular.core.integration.base.BaseInfrastructurePortTest
...
@Component
class ArangodbInfrastructurePortTest : BaseInfrastructurePortTest() {
    @Autowired
    ...
    override val testMergeRequests =
        listOf(
            MergeRequest(
                "1",
                201,
    ...
    private fun connectCommitsToFiles() {
        ...
        val connection =
            CommitFileConnection(
                "commit_${commit1Id}_file_$file1Id",
                commit1,
                file1,
                100,
            )
