...
import com.inso_world.binocular.web.persistence.entity.arangodb.CommitBuildConnectionEntity
...
class CommitBuildConnectionDao @Autowired constructor(
    ...
    override fun findBuildsByCommit(commitId: String): List<Build> {
        ...
        return buildEntities.map { buildMapper.toDomain(it as com.inso_world.binocular.web.persistence.entity.arangodb.BuildEntity) }
    }
    ...
    override fun findCommitsByBuild(buildId: String): List<Commit> {
        ...
        return commitEntities.map { commitMapper.toDomain(it as com.inso_world.binocular.web.persistence.entity.arangodb.CommitEntity) }
    }
