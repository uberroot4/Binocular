package com.inso_world.binocular.web.persistence.model
...
data class Page<T>(
    ...
    constructor(content: List<T>, totalElements: Long, pageable: Pageable) : this(
        ...
        last = pageable.pageNumber == (if (pageable.pageSize > 0) Math.ceil(totalElements.toDouble() / pageable.pageSize).toInt() - 1 else 0),
