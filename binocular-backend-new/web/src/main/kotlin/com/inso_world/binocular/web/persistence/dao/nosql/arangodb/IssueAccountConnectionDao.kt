...
import com.inso_world.binocular.web.persistence.entity.arangodb.IssueAccountConnectionEntity
...
class IssueAccountConnectionDao @Autowired constructor(
  ...
  /**
    ...
    override fun save(connection: IssueAccountConnection): IssueAccountConnection {
        ...
        val entity = IssueAccountConnectionEntity(
            id = connection.id,
            from = issueEntity,
            to = accountEntity
        )
