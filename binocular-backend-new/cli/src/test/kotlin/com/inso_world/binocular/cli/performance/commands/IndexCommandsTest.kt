...
class IndexCommandsTest : PerformanceTest(){
    ...
    @Autowired lateinit var idxClient: Index

    @Autowired private lateinit var projectPort: ProjectInfrastructurePort
    @Autowired private lateinit var commitPort: CommitInfrastructurePort
    @Autowired private lateinit var repositoryPort: RepositoryInfrastructurePort
    @Autowired private lateinit var branchPort: BranchInfrastructurePort
