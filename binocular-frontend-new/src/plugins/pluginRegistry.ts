...
const changes = createVisualizationPlugin<ChangesSettings, DataPluginCommit>(
  Changes,
);
const builds = createVisualizationPlugin<BuildSettings, DataPluginBuild>(
  Builds,
);
const issues = createVisualizationPlugin<IssueSettings, DataPluginIssue>(
  Issues,
);
const mergeRequest = createVisualizationPlugin<
  MergeRequestsSettings,
  DataPluginMergeRequest
>(MergeRequests);
const timeSpent = createVisualizationPlugin<TimeSpentSettings, DataPluginNote>(
  TimeSpent,
);
