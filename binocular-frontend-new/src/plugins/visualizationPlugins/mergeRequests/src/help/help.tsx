function Help() {
  ...
  return (
    <>
      ...
      <h3>Data</h3>
      <p>
        (Github only) The builds visualization provides an overview of the build statuses. It allows users to track the outcomes of builds,
        including successful, failed, and cancelled builds.
      </p>
      <h3>Parameters</h3>
      <div>
