...
import { DataState, current_file, setCurrentFileCommits, setCurrentFileTotalCommits, setDataState, setDateRange, setDateOfOverallFirstCommit, setDateOfOverallLastCommit, ChangesState, setCurrentFile } from '../reducer';
