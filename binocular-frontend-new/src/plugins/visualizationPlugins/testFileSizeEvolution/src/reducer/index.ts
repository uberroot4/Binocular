...
export interface TestFileSizeEvolutionState {
...
const initialState: TestFileSizeEvolutionState = {
  commits: [],
  files: [],
...
export const { setCommits, setFiles, setCommitsFilesConnections, setDateRange, setDataState } = changesSlice.actions;
